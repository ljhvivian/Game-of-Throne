...
#include<sstream>
#include <map>
int Gameworld3::_randomProduceBomb=0;
int Gameworld3::_monsterCount=0;
int Gameworld3::_bombCount = 0;
int Gameworld3::_score3 =0;
Gameworld3::Gameworld3(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Gameworld3)
{
    ui->setupUi(this);
    //init game world
    _game.initWorld("D:\\Bomber3\\mapfile2.txt");
...
Gameworld3::~Gameworld3()
{
    delete ui;
}

void Gameworld3::paintEvent(QPaintEvent *e){
    Q_UNUSED(e);
    QPainter *pa;
    pa = new QPainter();
    pa->begin(this);
    ...
    if(_game.getWP3()) {_game.clearbomb();_game.clearMonster();_game.clearObj();close();}
}

void Gameworld3::keyPressEvent(QKeyEvent *e)
{
